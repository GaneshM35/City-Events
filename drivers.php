...
<?php
  ...
  $getdrivers = mysqli_query($con,$query);
?>
<!DOCTYPE html>
<html>
...
<div class="w3-sidebar w3-bar-block w3-card-2 w<div class="w3-sidebar w3-bar-block w3-light-grey w3-card-2 w3-animate-left" style="display:none" id="mySidebar">
...
<img src="images/driver.jpg" alt="Announcement" style="width:60%">

<div class="w3-container">
  <h2>Acting Drivers </h2>
  <p>Available in Coimbatore</p>
  <div class="row">
  <div class="col-lg-12 full-width-media-text">
  <?php while($row = mysqli_fetch_assoc($getdrivers)) : ?>
    <div class="col-lg-3 col-sm-3">
      ...
      <div class="w3-container">
      <ul>
        <li><span class = "Title">Driver name :</span><span><?php echo $row['driver_name'] ?></span></li>
        <li><span class = "Title">Area :</span><span><?php echo $row['area'] ?></span></li>
        <li><span class = "Title">Address :</span><span><?php echo $row['address'] ?></span></li>
        </ul>
      </div>

      <footer class="w3-container w3-blue">
        <h5><span>Phone :</span><span class="pull-right"><?php echo $row['number'] ?></span></h5>
     </footer>
    </div>
  <?php endwhile; ?>
  </div>
