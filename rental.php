...
<?php
  ...
  $getRental = mysqli_query($con,$query);
?>
<!DOCTYPE html>
<html>
...
<img src="images/rental.jpg" alt="Donate Blood" style="width:60%">

<div class="w3-container">
  <h2>Rentals Houses in Coimbatore</h2>
</div>
...
<div class="w3-container">
  ...
  <?php while($row = mysqli_fetch_assoc($getRental)) : ?>
        <tr>
        ...
        <td><form action='message.php' method='POST'><input type='hidden' name='tempId' value= <?php echo $row['Phone'] ?>/>
              <span>
              <button type="button" data-id =<?php echo $row['Phone'] ?> class="open-message btn btn-info btn-lg" data-toggle="modal" data-target="#reqrental">Send Message</button>

  <!-- Modal -->
  <div class="modal fade" id="reqrental" role="dialog">
